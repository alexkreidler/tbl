...
#[clap(
    author,
    about = cstr!("<white><bold>tabl</bold></white> is a tool for reading and editing tabular data files"),
    override_usage = cstr!("<white><bold>tabl</bold></white> has two modes
1. Summary mode: <white><bold>tabl [ls | schema] [SUMMARY_OPTIONS]</bold></white>
2. Data mode:    <white><bold>tabl [DATA_OPTIONS]</bold></white>

Get help with <white><bold>SUMMARY_OPTIONS</bold></white> using <white><bold>tabl [ls | schema] -h</bold></white>
